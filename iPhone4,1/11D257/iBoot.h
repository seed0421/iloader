...
#define IMAGE_END               0x9FF526A4
#define IMAGE_SIZE              (IMAGE_END - IMAGE_START)
#define IMAGE_HEAP_SIZE         0xA495C
...
#define get_mem_size_ADDR       (0x1F144 + 1)
...
#define panic_ADDR              (0x201EC + 1)
#define system_init_ADDR        (0x202D8 + 1)
#define task_create_ADDR        (0x20908 + 1)
#define task_start_ADDR         (0x20A68 + 1)
#define task_exit_ADDR          (0x20A8C + 1)
#define printf_ADDR             (0x32E7C + 1)
#define malloc_ADDR             (0x196D8 + 1)
#define free_ADDR               (0x1978C + 1)
#define create_envvar_ADDR      (0x17FFC + 1)
